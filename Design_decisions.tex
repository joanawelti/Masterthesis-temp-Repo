...
\begin{itemize}
 ...
 \item Client-centric toolkit, server side more important in this project
...
Java
\begin{itemize}
 \item unlike dynamic languages, refactoring, benefits of a good IDE like NetBeans or Eclipse.
\end{}

Other options would have been the Java framework Play\footnote{Play \url{http://www.playframework.org/}}, Grails\footnote{Grails \url{http://grails.org/}} that uses the Groovy programming language or CakePHP\footnote{CakePHP \url{http://cakephp.org}}. Those framework are all very similar in terms of their functionality and architecture choices.  
